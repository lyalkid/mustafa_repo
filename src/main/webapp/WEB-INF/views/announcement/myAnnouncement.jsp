        ...
        <c:forEach var="announcement" items="${announcements}">
            <div class="announcement-item">
                <h3 class="announcement-name">
                    <a href="${pageContext.request.contextPath}/announcements/my/${announcement.id}">${announcement.getTitle()}</a>
                </h3>
            </div>
        </c:forEach>
    </div>
...
<a href="${pageContext.request.contextPath}/announcements" class="back-link">Back to Announcements</a>
</body>
</html>