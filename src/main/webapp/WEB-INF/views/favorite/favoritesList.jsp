...
<head>
    <meta charset="UTF-8">
    <title>Favorite Announcements</title>
...
<a href="${pageContext.request.contextPath}/announcements/my" class="back-link">Back to My Announcement</a>
</body>
</html>